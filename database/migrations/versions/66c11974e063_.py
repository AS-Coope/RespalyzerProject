...
Revision ID: 66c11974e063
Revises: ee0a610eac4f
Create Date: 2023-04-17 23:34:02.481129
...
revision = '66c11974e063'
down_revision = 'ee0a610eac4f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('causes', sa.String(length=200), nullable=True),
    ...
    sa.Column('latitude', sa.Double(precision=10, asdecimal=4), nullable=True),
    sa.Column('longitude', sa.Double(precision=10, asdecimal=4), nullable=True),
